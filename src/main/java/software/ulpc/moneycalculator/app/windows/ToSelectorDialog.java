...
public class ToSelectorDialog extends JComboBox<String> implements SelectCurrencyDialog {
    private final MainFrame owner;

    public ToSelectorDialog(List<Currency> currencies, MainFrame owner) {
        this.owner = owner;
